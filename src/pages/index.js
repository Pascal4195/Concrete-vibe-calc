...
const VAULT_CONFIGS = [
  ...
  },
  {
    ...
    description:   'ETH-denominated. Liquid staking + lending yield strategies.',
  },
  {
    id:            'wbtc',
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap gap-3 text-xs font-mono opacity-40 text-[#00FF41]">
        ...
        {vault.fetchError && (
          <span className="text-[#FF3131]">⚠ {vault.fetchError.slice(0, 28)}...</span>
        )}
      </div>
  ...
  return (
    <div>
      ...
      <div className="relative z-10 min-h-screen px-4 py-8 max-w-7xl mx-auto">
        ...
        {/* FOOTER */}
        <footer className="mt-12 text-center font-mono text-xs opacity-12 text-[#00FF41] pb-4 space-y-1">
